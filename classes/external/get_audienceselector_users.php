...
/**
 * Provides {@link local_announcements\external\get_audienceselector_users} trait.
 *
 ...
 */
trait get_audienceselector_users {
     ...
     */
    public static function get_audienceselector_users_parameters() {
        return new external_function_parameters([
            'audiencesjson' => new external_value(PARAM_RAW, 'The audience JSON')
        ]);
    }
    ...
    public static function get_audienceselector_users($audiencesjson) {
        self::validate_parameters(self::get_audienceselector_users_parameters(), compact('audiencesjson'));
        $postusers = announcement::get_audienceselector_users($audiencesjson);
        $users = ['userslist' => []];
     ...
     */
    public static function get_audienceselector_users_returns() {
