...
class form_settings_impersonators extends \moodleform {
    ...
    function definition() {
        ...
        $form->addElement('html', '<div class="form-group row fitem"><div class="col-md-3">Table columns</div><div class="col-md-9 form-inline felement"><strong>authorusername, impersonateuser</strong></div></div>');
