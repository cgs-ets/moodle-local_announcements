...
class form_settings_moderatorassistants extends \moodleform {
    ...
    function definition() {
        ...
        $form->addElement('html', '<div class="form-group row fitem"><div class="col-md-3">Table columns</div><div class="col-md-9 form-inline felement"><strong>modusername, assistantusername</strong></div></div>');

        $type = 'textarea'; 
        $name = 'moderatorassistants';
