...
$string['list:viewby'] = 'View by creator';
$string['list:viewbyself'] = 'View by self';
$string['list:exitviewby'] = 'Exit view by';
$string['list:viewbytitle'] = '<i class="fa fa-eye fa-fw" aria-hidden="true"></i> Viewing by {$a}';
...
$string['config:cronsendnum'] = 'Notification batch amount';
