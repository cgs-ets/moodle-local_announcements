...
function xmldb_local_announcements_upgrade($oldversion) {
    ...
    if ($oldversion < 2025052103) {
        // Define table ann_digest_queue to be created.
        $table = new xmldb_table('ann_digest_queue');
    ...
    if ($oldversion < 2025052105) {
        // Define table ann_pushnotifications_queue to be created.
        $table = new xmldb_table('ann_pushnotifications_queue');
